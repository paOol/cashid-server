                ...
                <ol class="list-view">
                    <li>
                        <div class="list-detail">
                            ...
                            <pre>curl --request POST \ --url https://auth.cashid.org/api/request \ --header 'content-type: application/json' \ --data '{ "action": "examplestring", "data": "examplestring", "required": { "identity": [ "name", "family" ], "position": [ "country" ], "contact": [ "email" ] }, "optional": { "identity": [ "age", "gender" ], "position": [ "city" ] } }'
                            </pre>
